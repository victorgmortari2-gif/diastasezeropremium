    ...
    return (
        <div className="bg-beige/50 p-6 sm:p-8 rounded-lg text-foreground">
            ...
            <div className="space-y-8">
                <Card className="bg-white">
                    <CardHeader>
                        <CardTitle className="font-headline text-xl flex items-center gap-3"><PartyPopper className="h-6 w-6 text-primary" />Celebre de Forma Significativa</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="bg-white">
                    <CardHeader>
                        <CardTitle className="font-headline text-xl flex items-center gap-3"><Rocket className="h-6 w-6 text-primary" />Os Próximos Passos: Da Meta ao Estilo de Vida</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p className="mb-4 text-muted-foreground">O plano que você seguiu foi a rampa de lançamento. Agora, a meta é transformar o que você aprendeu em um estilo de vida sustentável. Sua jornada não termina aqui; ela evolui. Para isso, incorpore estes três pilares:</p>
                        <div className="space-y-4">
                            {nextStepsPillars.map((pillar, index) => (
                                <div key={index} className="border-l-4 border-primary/20 pl-4">
                ...
                <Card className="bg-primary/10 border border-primary/20">
                    <CardHeader>
                        <CardTitle className="font-headline text-xl flex items-center gap-3 text-primary"><Star className="h-6 w-6" />O Convite para a Continuidade</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p className="text-foreground/90">
            ...
            <div className="text-center mt-10">
                <h3 className="font-headline text-2xl font-bold text-accent mb-2">Sua Jornada Acaba de Começar de Verdade!</h3>
