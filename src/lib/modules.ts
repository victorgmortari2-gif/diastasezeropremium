...
export const modules: Module[] = [
  ...
  },
  {
    ...
    objectives: [
     ...
     schedule: [
        { day: 8, slug: 'hipopressivos-progressao', title: 'Treinos Hipopressivos com Progressão', type: 'Exercício', duration: '11 min', description: 'Novas posturas e desafios para seu treino.', videoUrl: 'https://www.youtube.com/embed/z4CvXcK7XJ4' },
        { day: 9, slug: 'workshop-zere-diastase', title: 'Workshop: "Zere sua diástase sem cirurgia"', type: 'Workshop', duration: '12 min', description: 'Uma aula completa com o passo a passo para a recuperação.', videoUrl: 'https://www.youtube.com/embed/9TIYq-9XQUQ' },
        ...
        { day: 11, slug: 'treino-estabilidade', title: 'Treino de Estabilidade com Foco no Core', type: 'Exercício', duration: '27 min', description: 'Exercícios que desafiam e fortalecem seu centro.', videoUrl: 'https://www.youtube.com/embed/SSctsslEj0E' },
        { day: 12, slug: 'pratica-integrada-2', title: 'Prática Integrada - Semana 2', type: 'Exercício', duration: '24 min', description: 'Um treino completo unindo todos os aprendizados.', videoUrl: 'https://www.youtube.com/embed/LkTHczGwU50' },
  ...
  },
  {
    ...
    schedule: [
        ...
        { day: 16, slug: 'mentoria-abdomen-firme', title: 'Mentoria: Como Manter o Abdômen Firme', type: 'Mentoria', duration: '40 min', description: 'Segredos e estratégias para resultados duradouros.', videoUrl: 'https://www.youtube.com/embed/eJibnWJad44' },
        ...
        { day: 21, slug: 'revisao-geral', title: 'Revisão Geral e Dúvidas Finais', type: 'Workshop', duration: '10 min', description: 'Uma última chance para tirar todas as suas dúvidas.' },
    ]
  },
  {
    ...
    schedule: [
        { day: 1, slug: 'exercicios-cintura', title: 'Exercícios para Afinar Cintura', type: 'Exercício', duration: '11 min', description: 'Movimentos que tonificam os oblíquos e modelam a cintura.', videoUrl: 'https://www.youtube.com/embed/LylrJB4yCKc' },
        { day: 2, slug: 'escultura-abdominal', title: 'Técnicas de Escultura Abdominal Leve', type: 'Vídeo Aula', duration: '8 min', description: 'Automassagem para melhorar o contorno corporal.', videoUrl: 'https://www.youtube.com/embed/mCwFo3fxzr4' },
        { day: 3, slug: 'rituais-autocuidado', title: 'Rituais de Autocuidado com Foco Estético', type: 'Material', duration: '17 min', description: 'Dicas de cremes, óleos e práticas para a pele.' },
        { day: 4, slug: 'postura-elegancia', title: 'Postura e Elegância no Dia a Dia', type: 'Workshop', duration: '20 min', description: 'Como manter uma postura que valoriza seu corpo.' },
    ]
  },
  {
    ...
    schedule: [
        { day: 1, slug: 'manter-constancia', title: 'Como Manter Constância na Rotina', type: 'Workshop', duration: '14 min', description: 'Estratégias mentais e práticas para não desistir.', videoUrl: 'https://www.youtube.com/embed/2nxewgS5CCw' },
