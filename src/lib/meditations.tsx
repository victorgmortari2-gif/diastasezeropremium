...
export const meditations: Meditation[] = [
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/irZ304T3P8k',
    type: 'Meditação Guiada',
    benefits: ['Força de vontade inabalável', 'Fim da procrastinação', 'Autocontrole', 'Resiliência mental'],
    whatYouWillExperience: [
        'Fortalecimento da sua resolução e força de vontade.',
        'Técnicas para manter o foco em suas metas.',
        'Visualizações para construir resiliência mental.',
        'Um senso renovado de poder e controle pessoal.',
    ],
    info: {
        duration: '17 minutos',
        type: 'Disciplina',
